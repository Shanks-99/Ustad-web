...
export default function GoogleReviewCard() {
  return (
    <div className="inline-flex items-center gap-4 p-4 pr-6 bg-white border border-[#E5E7EB] rounded-2xl max-w-max shadow-[0_4px_20px_rgba(0,0,0,0.06)] notranslate" translate="no">
      ...
      <div className="flex flex-col justify-center">
        ...
        <span className="text-xs text-[#6B7280] font-medium notranslate" translate="no">Google · 200+ reviews</span>
      </div>
    </div>
  );
}
